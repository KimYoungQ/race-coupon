...
import org.coupon.productservice.security.AuthenticatedUser;
 ...
 * <p>목적이 둘이다.
 * <ul>
 *     <li>게이트웨이를 우회한 직접 호출 차단. 재검증이 없으면 내부망에 닿는 누구나
 *         인증 없이 상품을 등록할 수 있다.</li>
 *     <li>요청 주체 복원. 컨트롤러가 {@code @AuthenticationPrincipal}로 역할·userId를 꺼낼 수 있게 한다.</li>
 * </ul>
 *
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
     ...
     * 상품 서비스에는 로그인 경로가 없으므로(토큰 발급은 user-service) 제외 대상은 이것뿐이다.
     */
    @Override
