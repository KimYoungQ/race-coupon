...
import org.coupon.productservice.jwt.JwtAuthenticationEntryPoint;
import org.coupon.productservice.jwt.JwtAuthenticationFilter;
 ...
 *         재검증이 없으면 내부망에 닿을 수 있는 누구나 인증 없이 상품을 등록할 수 있다.</li>
 *     <li>요청 주체를 복원한다. 주체는 검증된 토큰의 {@code sub}에서만 얻는다 —
 *         클라이언트가 적어 보낸 헤더를 신뢰하면 타인 명의 요청이 가능해진다.</li>
 * </ul>
 *
...
// JwtSecretProperties는 org.coupon.common.security 패키지라 컴포넌트 스캔 범위 밖이다.
